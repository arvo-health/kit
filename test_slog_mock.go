...
// NewTestLogger creates a new test logger and its associated mock log handler for testing log outputs.
func NewTestLogger() (*slog.Logger, *MockLogHandler) {
	handler := NewMockLogHandler()
